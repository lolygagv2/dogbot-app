...
// B163 (2026-09-04, Morgan): the home-screen "Robot may be on its own
// hotspot — GO LOCAL" banner was removed. Nobody switches that way, and its
// reappearance while trying to get OUT of local mode caused a double
// local_mode tap that wedged treatbot2's relay client. Local mode is reached
// only via Settings → LocalModeSwitchTile below.
