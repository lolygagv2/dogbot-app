...
final _predefinedMissions = [
  ...
  const Mission(
    id: 'sit',
    name: 'Sit',
    description: 'Quick sit mission - wait for dog, then reward sit',
    targetBehavior: 'sit',
  ...
  const Mission(
    id: 'sit_training',
    name: 'Sit Training',
    description: 'Basic sit training - rewards dog for sitting behavior',
    targetBehavior: 'sit',
    requiredDuration: 3.0,
    cooldownSeconds: 15,
    dailyLimit: 10,
  ...
  const Mission(
    id: 'sit_sustained',
    name: 'Sit Sustained',
    description: 'Dog holds sit position for extended duration (30 seconds)',
    targetBehavior: 'sit',
    requiredDuration: 30.0,
    cooldownSeconds: 30,
    dailyLimit: 8,
  ),
  const Mission(
    id: 'down_sustained',
    name: 'Lay Down Sustained',
    description: 'Dog holds lay down position for extended duration (30 seconds)',
    targetBehavior: 'laydown',
    requiredDuration: 30.0,
    cooldownSeconds: 30,
    dailyLimit: 8,
  ),
  const Mission(
    id: 'come_and_sit',
    name: 'Come and Sit',
    description: 'Call the dog over, then ask for a sit',
    targetBehavior: 'sit',
    requiredDuration: 3.0,
    cooldownSeconds: 20,
    dailyLimit: 10,
  ...
  const Mission(
    id: 'laydown',
    name: 'Lay Down',
    description: 'Quick lay down mission - wait for dog, then reward lay down',
    targetBehavior: 'laydown',
    requiredDuration: 3.0,
    cooldownSeconds: 15,
    dailyLimit: 10,
  ...
  const Mission(
    id: 'come_training',
    name: 'Come Training',
    description: 'Recall training - rewards dog for coming when called',
    targetBehavior: 'come',
    requiredDuration: 3.0,
    cooldownSeconds: 20,
    dailyLimit: 10,
  ...
  const Mission(
    id: 'spin_training',
    name: 'Spin Training',
    description: 'Spin trick training - rewards dog for spinning in a circle',
    targetBehavior: 'spin',
    requiredDuration: 3.0,
    cooldownSeconds: 15,
    dailyLimit: 10,
  ...
  const Mission(
    id: 'speak_morning',
    name: 'Speak Morning',
    description: 'Dog barks on cue twice during morning (8am-12pm)',
    targetBehavior: 'speak',
    requiredDuration: 3.0,
    cooldownSeconds: 60,
    dailyLimit: 2,
  ...
  const Mission(
    id: 'speak_afternoon',
    name: 'Speak Afternoon',
    description: 'Dog barks on cue twice during afternoon (2pm-6pm)',
    targetBehavior: 'speak',
    requiredDuration: 3.0,
    cooldownSeconds: 60,
    dailyLimit: 2,
  ...
  const Mission(
    id: 'alert_training',
    name: 'Alert Training',
    description: 'Guard dog training - rewards dog for sitting and giving alert barks',
    targetBehavior: 'alert',
    requiredDuration: 3.0,
    cooldownSeconds: 30,
    dailyLimit: 6,
  ),
  ...
  const Mission(
    id: 'bark_prevention',
    name: 'Bark Prevention',
    description: 'Quiet training - reduces excessive barking behavior',
  ...
  const Mission(
    id: 'quiet_progressive',
    name: 'Quiet Progressive',
    description: 'Progressive quiet training - increasing quiet duration requirements',
    targetBehavior: 'quiet',
    requiredDuration: 10.0,
    cooldownSeconds: 30,
    dailyLimit: 6,
  ...
  const Mission(
    id: 'morning_chill',
    name: 'Morning Chill',
    description: 'Dog maintains calm behavior during morning (8am-12pm)',
    targetBehavior: 'calm',
    requiredDuration: 60.0,
    cooldownSeconds: 120,
    dailyLimit: 4,
  ),
  const Mission(
    id: 'morning_quiet_2hr',
    name: 'Morning Quiet 2hr',
    description: 'Dog maintains quiet for 2 hours during morning period (7am-1pm)',
    targetBehavior: 'quiet',
    requiredDuration: 120.0,
    cooldownSeconds: 180,
    dailyLimit: 2,
  ),
  const Mission(
    id: 'afternoon_sit_5',
    name: 'Afternoon Sit 5',
    description: 'Dog performs 5 sits during afternoon (12pm-7pm)',
    targetBehavior: 'sit',
    requiredDuration: 3.0,
    cooldownSeconds: 30,
    dailyLimit: 5,
  ...
  const Mission(
    id: 'afternoon_down_3',
    name: 'Afternoon Lay Down 3',
    description: 'Dog performs 3 lay downs during afternoon (12pm-6pm)',
    targetBehavior: 'laydown',
    requiredDuration: 3.0,
    cooldownSeconds: 30,
    dailyLimit: 3,
  ...
  const Mission(
    id: 'evening_calm_transition',
    name: 'Evening Calm Transition',
    description: 'Help dog transition to quiet evening behavior (6pm-9pm)',
    targetBehavior: 'calm',
    requiredDuration: 30.0,
    cooldownSeconds: 60,
    dailyLimit: 3,
  ...
  const Mission(
    id: 'evening_settle',
    name: 'Evening Settle',
    description: 'Dog settles down after dinner (5pm-9pm)',
    targetBehavior: 'settle',
    requiredDuration: 30.0,
    cooldownSeconds: 60,
    dailyLimit: 3,
  ),
  const Mission(
    id: 'night_quiet_90pct',
    name: 'Night Quiet 90%',
    description: 'Dog maintains 90% quiet overnight (7pm-4am)',
    targetBehavior: 'quiet',
    requiredDuration: 300.0,
    cooldownSeconds: 600,
    dailyLimit: 1,
  ),
];
